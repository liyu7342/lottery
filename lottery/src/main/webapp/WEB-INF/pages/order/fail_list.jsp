                    ...
                    <div id="xiazhumsg" class="module ">
                        <div class="hd g-tm">
                            <h2 class="g-tit">
                                ...
                                &nbsp;&nbsp;
                                <input type='radio' name='to_link' id='to_link' value="list?id=${id}" />
                                成功明細&nbsp;
                                <input type='radio' name='to_link' id='to_link' value="fail_list?id=${id}" checked='checked'/>
                                <font color='red'>失敗明細</font> <select name="categoryId" id="categoryId">
                                <option <#if categoryId=="" >selected=selected</#if> value='-1'>全部</option>
