        ...
        <div id="adminheader" class="module" >
            ...
            <div class="bd">
                <div class="ps"><div class="h o">
                    ...
                    <div class="rt">賬號:${user.account!''},管理员</div>
            ...
            <div class="ft">
                <ul class="clearfix" id="nav">
                    ...
                    <li ><a target='main' href="/notice/create">公告</a></li>
                </ul>
            </div>
        </div>   </div>
...
<!--<script type="text/javascript">
    ...
    script.type = 'text/javascript';
    script.src ='/chat/webchat/js/customer.js?v='+(+new D       n  ate());
