                                ...
                                <#list handicaps as obj>
                                    <tr level="5">
                                        ...
                                        <td class="bl">
                                            ...
                                            <span><#if obj.tema??>+</#if></span> <em class="ico n${obj.tema!''}"></em> <font
                                        ...
                                        <td>
                                            <a class='a_btm_line' href='/handicap/info?op=upd&id=${obj.id}&pageId=1&keywordstatus=1&keyword=&level=5'>修改</a>
...
<script type="text/javascript">
    function page(pageid,pagesize,keyword){
        location.href="/handicap/index?pageId="+pageid;
    }
    window.setting = {
