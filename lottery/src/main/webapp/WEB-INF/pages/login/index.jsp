...
<head>
    ...
    <script type="text/javascript">
        function headerToCps(link) {

            link.href = 'http://cps.' + location.host + '/net.html';
    ...
    <style type="text/css" charset="utf-8">
        ...
        .line{
            height: 1em;
            border-left: 1px solid #C8476B;
            border-right: 1px solid #8D0C31;
            margin-right: 0.5em;
        }
        .line2,.line3{
            height: 0.9em;
...
<div class='main'>
    ...
    <div class="mainRight">
        <p>
            <span class='h-txt'>線路選擇</span><span class="rightTit"></span>
        </p>
