            ...
            <div class="yui-b">
                <div class="yui-g">
                    <div id="shoufutongji" class="module">
                        <div class="hd">
                            <table class="g-jft"><tbody nomovod><tr id="total_plays">
                                ...
                                <td id="03" class="on sp"><a href="/statis/tjlianma?category_id=03|04"><span>連碼</span><sup title="總佔成收入">0</sup></a></td>
                    ...
                    <div class="bd">
                        ...
                        <input type="hidden" name="game_id" value='008|009|010|011|012"'>
