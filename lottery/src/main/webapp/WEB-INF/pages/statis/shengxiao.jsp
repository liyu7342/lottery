                ...
                <div class="yui-g">
                    <div id="shoufutongji" class="module">
                        ...
                        <div class="bd">
                            <div class="n2 g-tm">
                                <form>
                                    <div class="n1 g-rl"><strong>收付統計</strong> <a class="btn6 red" href="/statis/short_cover_list?game_id=${game_id!'014'}">補倉明細</a> <select name="type">
                    ...
                    <div class="bd">
                        ...
                        <input type="hidden" name="game_id" value='014'>
