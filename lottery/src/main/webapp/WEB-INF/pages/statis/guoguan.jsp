        ...
        <div id="yui-main">
            <div class="yui-b">
                <div class="yui-g">
                    <div id="shoufutongji" class="module">
                        <div class="hd">
                            <table class="g-jft"><tbody nomovod><tr id="total_plays">
                                ...
                                <td id="05" class="on sp"><a href="/statis/guoguan?category_id=05"><span>過關</span><sup title="總佔成收入">0</sup></a></td>
                    ...
                    <div class="hd"></div>
                    <div class="bd">
                        <input type="hidden" name="category_id" value='05'>
                        <input type="hidden" name="game_id" value='013'>
