...
<head>
    ...
    <link rel="stylesheet" href="/theme/gray/css/common.css?ms2.4.7_3106" type="text/css">
    <link rel="stylesheet" href="/theme/gray/css/mike.chen.css?ms2.4.7_3106" type="text/css">
                    ...
                    <div id="shoufutongji" class="module">
                        <div class="hd">
                            <table class="g-jft"><tbody nomovod><tr id="total_plays">
                                ...
                                <td id="12" class="on sp"><a href="/statis/texiao?category_id=12"><span>特肖</span><sup title="總佔成收入">0</sup></a></td>
                        ...
                        <div class="bd">
                            <div class="n2 g-tm">
                                <form>
                                    <div class="n1 g-rl"><strong>收付統計</strong> <a class="btn6 red" href="short_cover_list.htm?game_id=002">補倉明細</a> <select name="type">
                                        ...
                                        <div class="radiomenu">
                                            <h3 class="m g-rl">
                                                <a class="on"  href="tjzhengmate.htm?category_id=02&game_id=002">正1特</a>
                                                <a  href="tjzhengmate.htm?category_id=02&game_id=003">正2特</a>
                                                <a  href="tjzhengmate.htm?category_id=02&game_id=004">正3特</a>
                                                <a  href="tjzhengmate.htm?category_id=02&game_id=005">正4特</a>
                                                <a  href="tjzhengmate.htm?category_id=02&game_id=006">正5特</a>
                                                <a  href="tjzhengmate.htm?category_id=02&game_id=007">正6特</a>
                                            </h3>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <div class="ft"></div>
                    </div>                <div id="tjzhengmate" class="module g-mt0">
                    <div class="hd">
                    </div>
                    <div class="bd">
                        ...
                        <table class="g-t1 g-t2">
                            <thead><tr>
                                ...
                                <td>平均賠率</td>
                                <td>勝出金額</td>
                                <td>補倉(<span class="red">5,000</span>) <button act="db" class="gms_ctl" to="duobu.htm?game_id=002"  type="button" type="button">多補</button> </td>
                                <td act="pl">賠率
                            ...
                            <tr id="00228">
                                <td>1</td>
                                <td><a href="javascript:void(0);" to="xiazhumingxi.htm?game_id=002&number=28&name=%E6%AD%A31%E7%89%B9+28"class=" green">正1特 28</a></td>
                                <td>1</td>
                                <td>10</td>
                                <td>3</td>
                                <td>0</td>
                                <td>126</td>
                                <td>42.000</td>
                                <td>-121</td><td><a href="javascript:void(0);" to="short_covering.htm?game_id=002&number=28" class="red gms_a">0</a></td><td><span oddsSet='A' >42.000</span><span oddsSet='B' class="hid">42.000</span><span oddsSet='C' class="hid">42.000</span></td></tr></tbody><tr id="00211">
                            <td>2</td>
                            <td><a href="javascript:void(0);" to="xiazhumingxi.htm?game_id=002&number=11&name=%E6%AD%A31%E7%89%B9+11"class=" green">正1特 11</a></td>
                            <td>1</td>
                            <td>5</td>
                            <td>1</td>
                            <td>0</td>
                            <td>63</td>
                            <td>42.000</td>
                            <td>-58</td><td><a href="javascript:void(0);" to="short_covering.htm?game_id=002&number=11" class="red gms_a">0</a></td><td><span oddsSet='A' >42.000</span><span oddsSet='B' class="hid">42.000</span><span oddsSet='C' class="hid">42.000</span></td></tr></tbody><tr id="00214">
                            <td>3</td>
                            <td><a href="javascript:void(0);" to="xiazhumingxi.htm?game_id=002&number=14&name=%E6%AD%A31%E7%89%B9+14"class=" blue">正1特 14</a></td>
                            <td>1</td>
                            <td>3</td>
                            <td>0</td>
                            <td>0</td>
                            <td>37</td>
                            <td>42.000</td>
                            <td>-33</td><td><a href="javascript:void(0);" to="short_covering.htm?game_id=002&number=14" class="red gms_a">0</a></td><td><span oddsSet='A' >42.000</span><span oddsSet='B' class="hid">42.000</span><span oddsSet='C' class="hid">42.000</span></td></tr></tbody>    <tfoot>
                        <tr>
                            <td colspan="2">總計</td>
                            <td>3</td>
                            <td>18</td>
