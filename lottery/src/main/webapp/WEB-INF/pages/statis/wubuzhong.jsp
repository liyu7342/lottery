                ...
                <div class="yui-g">
                    <div id="shoufutongji" class="module">
                        ...
                        <div class="bd">
                            <div class="n2 g-tm">
                                <form>
                                    <div class="n1 g-rl"><strong>收付統計</strong> <a class="btn6 red" href="/statis/short_cover_list?game_id=${game_id}">補倉明細</a> <select name="type">
                                        ...
                                        <div class="radiomenu">
                                            <h3 class="m g-rl">
                                                <a <#if game_id=="047">class="on"</#if>  href="/statis/wubuzhong?category_id=15&game_id=047">五不中</a>
                                                <a <#if game_id=="048">class="on"</#if>  href="/statis/wubuzhong?category_id=15&game_id=048">六不中</a>
                                                <a <#if game_id=="049">class="on"</#if>  href="/statis/wubuzhong?category_id=15&game_id=049">七不中</a>
                                                <a <#if game_id=="050">class="on"</#if>  href="/statis/wubuzhong?category_id=15&game_id=050">八不中</a>
                                                <a <#if game_id=="051">class="on"</#if>  href="/statis/wubuzhong?category_id=15&game_id=051">九不中</a>
                                                <a <#if game_id=="052">class="on"</#if>  href="/statis/wubuzhong?category_id=15&game_id=052">十不中</a>
                                            </h3>
                                        </div>
