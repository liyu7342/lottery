...
<div id="doc3" class="yui-t2">
    <div id="bd">
        <div id="yui-main">
            <div class="yui-b">
                <div class="yui-g">
                    <div id="sysbuhuo" class="module">
                        <div class="hd g-tm">
                            <h2 class="g-tit">補貨設定</h2>
                        </div>
                        <div class="bd">
                            <form name="form_sysbuhuo" action="" method="post">
                                <table class="g-t1 g-t2 g-hover" id="buhuo_body">
                                    <thead>
                                    <tr><th></th><td>特碼</td><td>正碼</td><td>正碼特</td><td>連碼二</td><td>三全中</td><td>三中二</td><td>過關</td><td>生肖</td><td class="r">尾數</td></tr>
                                    </thead>
                                    <tbody nomovod>
                                    <tr class="bg">
                                        <td>設置</td>
                                    ...
                                    <tr class="bg">
                                        <td></td><td>半波</td><td>六肖</td><td>兩面</td><td>色波</td><td>特肖</td><td>生肖連</td><td>尾數連</td><td>不中</td><td></td>
                                    </tr>
                                    <tr>
                                        <td class="bg">設置</td>
                                ...
                                <input type="hidden" name="status" id="buhuo_status" value="init"/>
                                <input type="hidden" name="chg"/>
                                <div class="g-tn"><input type="button" class="btn2" value="保存設置" act="sysconfig_buhuo" id="sysconfig_buhuo"/></div>
                            </form>
                        </div>
                        <div class="ft">
                            說明：自動補倉從你開啟此項功能開始，每一個新單都會幫你進行超額計算，同時限定<u>最小自動下調金額</u>大於等於0。<br>
                            例如：某佔成設置為300，如果此時你的佔成小於300系統則不會自動幫你補；必須佔成大於300時，係統才會幫你補掉大於300的那部分。
                        </div>
                    </div>                </div>
            </div>
        </div>
        <div class="yui-b">
            <div id="sysli" class="module g-li">
                <div class="hd g-tif"><h3>系統設定</h3></div>
                <div class="bd">
                    <ul>
                        <li class="even"><a href="buhuo.htm">補貨設定</a></li>
                    </ul>
                </div>
                <div class="ft"><div class="dotbg"></div></div>
            </div>        </div>
    </div>
    <div id="ft">
