        ...
        <div id="adminheader" class="module" >
            ...
            <div class="bd">
                <div class="ps"><div class="h o">
                    ...
                    <div class="rt">賬號:${user.name!''}, <#if user.usertype==1>大股东<#elseif  user.usertype==2>小股东<#elseif user.usertype==3>总代理<#elseif user.usertype==4>代理<#elseif user.usertype==5>会员<#elseif user.usertype==0>管理员<#else>&nbsp;</#if></div>
            ...
            <div class="ft">
                <ul class="clearfix" id="nav">
                    ...
                    <li ><a target='main' href="/user/info">個人資訊</a></li>
                    <li ><a target='main' href="/user/password">密碼變更</a></li>
                </ul>
            </div>
        </div>   </div>
