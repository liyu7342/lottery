        ...
        <div id="adminheader" class="module" >
            ...
            <div class="bd">
                <div class="ps"><div class="h o">
                    ...
                    <div class="rt">賬號:${user.account!''}, <#if user.realUserType==1>大股東<#elseif  user.realUserType==2>小股東<#elseif user.realUserType==3>總代理<#elseif user.realUserType==4>代理<#elseif user.realUserType==6>管理员<#else>&nbsp;</#if></div>
