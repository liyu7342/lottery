            ...
            <div class="yui-b">
                <div class="yui-g">
                    ...
                    <div id="huiyuan" class="module">
                        <div class="hd g-tm">
                            <form id="form1" method="post" action="/user/index1">
                                ...
                                <ul>
                                    ...
                                    <li><h2><a class="btn10 mt red" href='/member/info1?op=create&id=&parentId='>新增</a>&nbsp;&nbsp;
                            ...
                            <table class="g-t1 g-t2">
                                ...
                                <#list users as obj>
                                    <tr level="5">
                                        ...
                                        <td class="bg tl"><a href='/user/index2?parentid=${obj.id}&level=2'>${obj.account!''}</a>&nbsp;&nbsp;[${obj.userName!''}]</td>
                                        <td>${obj.credits!''}</td>
                                        <td>${obj.handicap!''}</td>
                                        <td>${obj.shareUp!''}</td>
                                        <td>${obj.shareTotal!''}</td>
                                        <td>${obj.dagudongNumber!'0'}</td>
                                        <td>${obj.gudongNumber!'0'}</td>
                                            ...
                                            <#if obj.status==1>
                                                <a class='a_btm_line' act='tingyong'   pid="${obj.parentid !''}"
                                                   tid='${obj.id}' page='1' href='member_list.htm'>停用</a>/&nbsp;<a class='a_btm_line' act='tingya'   pid="${obj.parentid !''}"
                                                                                                                   tid='${obj.id}' page='1' href='member_list.htm'>停押</a>/&nbsp;<a class='a_btm_line'   pid="${obj.parentid !''}" href='/member/info1?op=upd&id=${obj.id}&pageId=1&keywordstatus=1&keyword=&level=5&parentId=${obj.parentid!''}'>修改</a>
                                            </#if>
                                            <#if obj.status==2>
                                                <a class='a_btm_line' act='qiyong'   pid="${obj.parentid !''}"
...
<script type="text/javascript">
    function page(index) {
        location.href = "/user/index1?pageId=" + index;
    }
</script>
