                            ...
                            <table class="g-t1 g-t2">
                                ...
                                <#list users as obj>
                                    <tr level="5">
                                        ...
                                        <td><a class='a_btm_line' act='tingyong' pid='${obj.parentId !''}'
                                               tid='${obj.id}' page='1' href='member_list.htm'>停用</a>
                                            /&nbsp;<a class='a_btm_line' act='tingya' pid='${obj.parentId !''}'
                                                      tid='${obj.id}' page='1' href='member_list.htm'>停押</a>
                                            /&nbsp;<a class='a_btm_line'
                                                      href='/member/info1?op=upd&id=${obj.id}&pageId=1&keywordstatus=1&keyword=&level=1'>修改</a>
                                        </td>
                                    </tr>
                                </#list>
                                </tbody>
