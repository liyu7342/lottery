                        ...
                        <div class="hd g-tm">
                            <form id="form1" method="GET" action="/user/index3">
                                ...
                                <ul>
                                    ...
                                    <li><h2><a class="btn10 mt red" href='/member/info3?op=create&id=&parentId=${currentUserId}'>新增</a>&nbsp;&nbsp;
                            ...
                            <table class="g-t1 g-t2">
                                ...
                                <tr level="5">
                                    ...
                                    <td><a class='a_btm_line' act='tingyong' pid='${obj.parentId !''}' tid='${obj.id}' page='1' href='member_list.htm'>停用</a>
                                        ...
                                        /&nbsp;<a class='a_btm_line' href='/member/info3?op=upd&id=${obj.id}&pageId=1&keywordstatus=1&keyword=&level=5&parentId=${obj.parentid}'>修改</a></td>
                                </tr>
                                    </#list>
                                </tbody></table>
            ...
            <div id="userli" curl="5" class="module g-li">
                ...
                <div class="bd">
                    <ul class="g-hover">
                        ...
                        <li><a curl='5' href='/user/index3'>总代理</a><cite>0</cite></li>
