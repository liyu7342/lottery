    ...
    <div id="bd">
            ...
            <div class="yui-b">
                <div class="yui-g">
                    ...
                    <div id="huiyuan" class="module">
                        <div class="hd g-tm">
                            <form id="form1" method="post" action="/user/admin_list">
                                ...
                                <ul>
                                    ...
                                    <li><h2><a class="btn10 mt red" href='/member/admin_create?op=create&id=&parentId='>新增</a>&nbsp;&nbsp;
        ...
        <div class="yui-b">
            <div id="userli" curl="5" class="module g-li">
                ...
                <div class="bd">
                    <ul class="g-hover">
                        <#if user.usertype gt 5>
                            <li><a curl='5' href='/user/admin_list'>管理員</a><cite>0</cite></li>
                        </#if>
...
<script type="text/javascript">
    function page(index) {
        location.href = "/user/iadmin_list?pageId=" + index;
    }
</script>
