...
<div id="doc3" class="yui-t2">
        ...
        <div id="adminheader" class="module" >
            ...
            <div class="ft">
                <ul class="clearfix" id="nav">
                    ...
                    <li ><a target='main' <#if user.usertype==5 > href="/user/info" <#else> href="/user/info"</#if> >個人資訊</a></li>
                    <li ><a target='main' href="/user/password1?e=1">密碼變更</a></li>
                </ul>
            </div>
        </div>   </div>
    <div id="bd" class="g-fm"><div class="gfm gfml"></div><div class="gfm gfmr"></div>
        <div id="yui-main">
            <div class="yui-b g-w">
                <div class="yui-g">
                    <iframe id="main" name="main" class="main" src="/user/password1" allowTransparency="true" frameborder="0" scrolling="yes"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="show_ip" id="show_ip" popup="1" style="display: none;"></div>
</div>
