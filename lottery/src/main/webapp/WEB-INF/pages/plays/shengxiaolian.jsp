...
<div id="doc3" class="yui-t7">
    ...
    <div id="bd">
        <div id="yui-main">
            <div class="yui-b">
                <div class="yui-g">
                    <div id="shengxiaolian" class="module" status='{"035":0,"036":0,"037":0,"038":0,"039":0,"040":0,"054":0,"055":0}'>
                        ...
                        <div class="bd">
                            <form id="form_mark">
                                ...
                                <table class="g-t1" id="ball">
                                    <tbody>
                                    <tr>
                                        <th class="bg"><label><input type="checkbox"  disabled="disabled"  value="01"/>鼠</label></th>
                                        <td><strong>10,22,34,46</strong></td><td width="10%" name="pro_01"></td>
                                        <th class="bg"><label><input type="checkbox"  disabled="disabled" value="02"/>牛</label></th>
                                        <td><strong>09,21,33,45</strong></td><td width="10%" name="pro_02"></td>
                                    </tr>
                                    <tr>
                                        <th class="bg"><label><input type="checkbox"  disabled="disabled" value="03"/>虎</label></th>
                                        <td><strong>08,20,32,44</strong></td><td name="pro_03"></td>
                                        <th class="bg"><label><input type="checkbox"  disabled="disabled" value="04"/>兔</label></th>
                                        <td><strong>07,19,31,43</strong></td><td name="pro_04"></td>
                                    </tr>
                                    <tr>
                                        <th class="bg"><label><input type="checkbox"  disabled="disabled" value="05"/>龍</label></th>
                                        <td><strong>06,18,30,42</strong></td><td name="pro_05"></td>
                                        <th class="bg"><label><input type="checkbox"  disabled="disabled" value="06"/>蛇</label></th>
                                        <td><strong>05,17,29,41</strong></td><td name="pro_06"></td>
                                    </tr>
                                    <tr>
                                        <th class="bg"><label><input type="checkbox"  disabled="disabled" value="07"/>馬</label></th>
                                        <td><strong>04,16,28,40</strong></td><td name="pro_07"></td>
                                        <th class="bg"><label><input type="checkbox"  disabled="disabled" value="08"/>羊</label></th>
                                        <td><strong>03,15,27,39</strong></td><td name="pro_08"></td>
                                    </tr>
                                    <tr>
                                        <th class="bg"><label><input type="checkbox"  disabled="disabled" value="09"/>猴</label></th>
                                        <td><strong>02,14,26,38</strong></td><td name="pro_09"></td>
                                        <th class="bg"><label><input type="checkbox"  disabled="disabled" value="10"/>雞</label></th>
                                        <td><strong>01,13,25,37,49</strong></td><td name="pro_10"></td>
                                    </tr>
                                    <tr>
                                        <th class="bg"><label><input type="checkbox"  disabled="disabled" value="11"/>狗</label></th>
                                        <td><strong>12,24,36,48</strong></td><td name="pro_11"></td>
                                        <th class="bg"><label><input type="checkbox"  disabled="disabled" value="12"/>豬</label></th>
                                        <td><strong>11,23,35,47</strong></td><td name="pro_12"></td>
                                    </tr>
                                    </tbody>
                                </table>
