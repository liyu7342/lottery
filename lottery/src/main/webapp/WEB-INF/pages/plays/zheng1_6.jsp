...
<div id="doc3" class="yui-t7">
    ...
    <div id="bd">
        <div id="yui-main">
            <div class="yui-b">
                <div class="yui-g">
                    <div id="zhengma1to6" class="module"  status='{"021":0,"022":0,"023":0,"024":0,"025":0,"026":0}'>
                        <input type="hidden" id="time_stamp" value="1497948387"/>
                        <input type="hidden" id="cps_time" value="20170621181117"/>
                        <div class="hd"><h2 class="g-tit"><span id="product_name">正1-6</span> 投注</h2></div>
                        <div class="bd">
                            <form id="form_mark">
                                <table class="g-t1">
                                    <thead><tr>
