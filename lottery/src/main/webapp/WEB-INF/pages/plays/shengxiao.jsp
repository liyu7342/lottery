...
<div id="doc3" class="yui-t7">
    ...
    <input type="radio" id="yeshou" name="w_fast" value="yeshou" disabled="disabled" /><label for="yeshou">野獸</label>
                            ...
                            <input type="button" class="shengxiao_switch red" value="生肖不中" onclick="window.location='shengxiaobuzhong.htm'"  />
                        </div>
                        <div class="bd">
                            <form id="form_mark">
                                <table class="g-t1" id="main_tab">
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td><input name="pro_01401" type="text"  class="dis" disabled="disabled" />
                                        </td>
                                        <td class="bg">牛</td>
                                        <td><strong>09,21,33,45</strong></td>
                                        <td></td>
                                        <td><input name="pro_01402" type="text"  class="dis" disabled="disabled"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bg">虎</td>
                                        ...
                                        <td></td>
                                        <td><input name="pro_01403" type="text"  class="dis" disabled="disabled"/>
                                        </td>
                                        <td class="bg">兔</td>
                                        <td><strong>07,19,31,43</strong></td>
                                        <td></td>
                                        <td><input name="pro_01404" type="text"  class="dis" disabled="disabled"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bg">龍</td>
                                        ...
                                        <td></td>
                                        <td><input name="pro_01405" type="text"  class="dis" disabled="disabled"/>
                                        </td>
                                        <td class="bg">蛇</td>
                                        <td><strong>05,17,29,41</strong></td>
                                        <td></td>
                                        <td><input name="pro_01406" type="text"  class="dis" disabled="disabled"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bg">馬</td>
                                        ...
                                        <td></td>
                                        <td><input name="pro_01407" type="text"  class="dis" disabled="disabled"/>
                                        </td>
                                        <td class="bg">羊</td>
                                        <td><strong>03,15,27,39</strong></td>
                                        <td></td>
                                        <td><input name="pro_01408" type="text"  class="dis" disabled="disabled"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bg">猴</td>
                                        ...
                                        <td></td>
                                        <td><input name="pro_01409" type="text"  class="dis" disabled="disabled"/>
                                        </td>
                                        <td class="bg">雞</td>
                                        <td><strong>01,13,25,37,49</strong></td>
                                        <td></td>
                                        <td><input name="pro_01410" type="text"  class="dis" disabled="disabled"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bg">狗</td>
                                        ...
                                        <td></td>
                                        <td><input name="pro_01411" type="text"  class="dis" disabled="disabled"/>
                                        </td>
                                        <td class="bg">豬</td>
                                        <td><strong>11,23,35,47</strong></td>
                                        <td></td>
                                        <td><input name="pro_01412" type="text"  class="dis" disabled="disabled"/>
                                        </td>
                                    </tr>
                                    </tbody></table>
                                <div class="g-tn">
