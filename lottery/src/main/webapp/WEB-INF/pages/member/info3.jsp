                            ...
                            <div class="bd g-new" >
                                ...
                                <table class="g-t1 g-t2 t1">
                                    <tbody nomovod><tr>
                                        ...
                                        <td>賬號</td>
                                        <td><input type="text" valid='account' title="4-12個數字或字母字符" maxlength="12"  name="account" <#if info.id!=""> disabled="disabled"</#if> value="${info.account!''}"  class="gray"/> </td>
                                        <td>密碼</td>
                                ...
                                <div class="g-tn"><input type="submit" name="submit" class="btn2" value="確 定"/>
                                    <input value="取 消" class="btn2" type="reset" onclick="location.href='/user/index3'"/></div>
                                ...
                                <input type="hidden" name="requestUrl" value='/user/index3'/>
