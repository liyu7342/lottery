                        ...
                        <form id="create" method="post" action="/member/save">
                            <div class="hd g-tm">
                                <ul>
                                    ...
                                    <li>&nbsp;&nbsp;<span>上级總代理：${parentUser.userName!''}</span></li>
                                    <li><a class="btn1 cs" onclick="location.href='/user/index4';return false;" href="javascript:void(0);">返回</a></li>
                                </ul>
                            </div>
                            <div class="bd g-new" >
                                ...
                                <table class="g-t1 g-t2 t1">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">總代理佔成數(<font color='red'>%</font>)
                                ...
                                <table class="g-t1 g-t2 mt t2 hline" id='dls_discount_body'>
                                ...
                                <div class="g-tn"><input type="submit" name="submit" class="btn2" value="確 定"/>
                                    <input value="取 消" class="btn2" type="reset" onclick="location.href='/user/index4'"/></div>
                                ...
                                <input type="hidden" name="requestUrl" value='/user/index4'/>
