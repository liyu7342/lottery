    ...
    <div id="bd">
                        ...
                        <div class="bd g-new">
                            ...
                            <form id="create" method="post" action="/member/saveAdmin">
                                ...
                                <table class="g-t1 g-t2 mt t2" id='permission_body'>
                                    ...
                                    <tbody nomovod><tr>
                                        <th>
                                            <label><input type="checkbox" value="01" checked="checked"  />賬號管理</label>
                                        </th>
                                        <th>
                                            <label><input type="checkbox" value="02" checked="checked"  />收付統計</label>
                                        </th>
                                        <th>
                                            <label><input type="checkbox" value="03" checked="checked"  />操盤記錄</label>
                                        </th>
                                        <th>
                                            <label><input type="checkbox" value="04" checked="checked"  />報表查詢</label>
                                        </th>
                                        <th>
                                            <label><input type="checkbox" value="05" checked="checked"  />開獎管理</label>
                                        </th>
                                        <th>
                                            <label><input type="checkbox" value="07" checked="checked"  />系統設定</label>
                                        </th>
                                    </tr>
                                    </tbody>
                                </table>
        ...
        <div class="yui-b">
            <div id="userli" curl="0" class="module g-li">
                ...
                <div class="bd">
                    <ul class="g-hover">
                        <li><a curl='0' href='admin_list.htm'>管理員</a><cite>1</cite></li>
                        <li><a curl='4' href='user_list.htm?level=4'>代理商</a><cite>2</cite></li>
                        <li><a curl='5' href='member_list.htm'>會員</a><cite>2</cite></li>
                    </ul>
                </div>
                <div class="ft">
                    <p>在線會員數：1</p>
