                ...
                <div class="yui-g">
                    ...
                    <div id=""class="module">
                        <div class="play_hd">
                            ...
                            <a href="/odds/sanzher?isDefault=false"class="on ds d-gray" disabled="disabled">三中二</a>
                        </div>
                        <form id="form1" method="POST" action="/odds/save">
                            <table class="g-t1">
                                ...
                                <tr>
                                    ...
                                    <td class="borderLeftNone"><input type="text" name="0129" value="${entity.pro_01209!''}"/>/<input type="text" name="0129_1" value="${entity.pro_01209_1!''}"/></td>
