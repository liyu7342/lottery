                        ...
                        <form id="form1" method="POST" action="/odds/save">
                            <table class="g-t1" id="main_tab">
                                ...
                                <tr>
                                    ...
                                    <td><input name="01401" type="text"  value="${(entity.pro_01401)!''}"/>
                                    </td>
                                    <td class="bg">牛</td>
                                    <td><strong>${shengxiao.牛}</strong></td>
                                    <td><input name="01402" type="text" value="${(entity.pro_01402)!''}" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bg">虎</td>
                                    ...
                                    <td><input name="01403" type="text" value="${(entity.pro_01403)!''}" />
                                    </td>
                                    <td class="bg">兔</td>
                                    <td><strong>${shengxiao.兔}</strong></td>

                                    <td><input name="01404" type="text"  value="${(entity.pro_01404)!''}"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bg">龍</td>
                                    ...
                                    <td><input name="01405" type="text"  value="${(entity.pro_01405)!''}"/>
                                    </td>
                                    <td class="bg">蛇</td>
                                    <td><strong>${shengxiao.蛇}</strong></td>
                                    <td><input name="01406" type="text" value="${(entity.pro_01406)!''}" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bg">馬</td>
                                    ...
                                    <td><input name="01407" type="text" value="${(entity.pro_01407)!''}" />
                                    </td>
                                    <td class="bg">羊</td>
                                    <td><strong>${shengxiao.羊}</strong></td>

                                    <td><input name="01408" type="text"  value="${(entity.pro_01408)!''}"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bg">猴</td>
                                    <td><strong>${shengxiao.猴}</strong></td>
                                    <td><input name="01409" type="text" value="${(entity.pro_01409)!''}" />
                                    </td>
                                    <td class="bg">雞</td>
                                    <td><strong>${shengxiao.雞}</strong></td>

                                    <td><input name="01410" type="text" value="${(entity.pro_01410)!''}" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bg">狗</td>
                                    ...
                                    <td><input name="01411" type="text"  value="${(entity.pro_01411)!''}"/>
                                    </td>
                                    <td class="bg">豬</td>
                                    <td><strong>${shengxiao.豬}</strong></td>
                                    <td><input name="01412" type="text" value="${(entity.pro_01412)!''}" />
                                    </td>
                                </tr>
                                </tbody>
                            </table>
            ...
            <div id="userli" curl="5" class="module g-li">
                ...
                <div class="bd">
                    <ul class="g-hover">
                        ...
                        <li><a curl='5' href='/odds/shengxiao?isDefault=false'>生肖</a><cite></cite></li>
