                ...
                <div class="yui-g">
                    ...
                    <div id=""class="module">
                        <div class="play_hd">
                            ...
                            <a href="/odds/erzhongte?isDefault=false" >二中特</a>&nbsp;|
                            <a href="/odds/techuan?isDefault=false" >特串</a>&nbsp;|
                            <a href="/odds/sanquanzh?isDefault=false" class="on ds d-gray" disabled="disabled">三全中</a>&nbsp;|
                            <a href="/odds/sanzher?isDefault=false">三中二</a>
                        </div>
                        <form id="form1" method="POST" action="/odds/save">
                            <table class="g-t1">
                                ...
                                <tr>
                                    ...
                                    <td class="borderLeftNone"><input type="text" name="0119" value="${entity.pro_01109!''}"/></td>
