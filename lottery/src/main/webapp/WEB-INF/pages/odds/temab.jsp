    ...
    <div id="bd">
        ...
        <div class="yui-b">
            <div id="userli" curl="5" class="module g-li">
                ...
                <div class="bd">
                    <ul class="g-hover">
                        <li><a curl='5' href='/odds/temaa'>特碼A</a><cite></cite></li><li><a curl='5' href='/odds/temab'>特碼B</a><cite></cite></li>
