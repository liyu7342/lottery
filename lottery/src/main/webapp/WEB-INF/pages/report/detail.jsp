            ...
            <div class="yui-b">
                <div class="yui-g">
                    <div id="odetail" class="module">
                        <div class="hd">
                            <p>四肖连(中) 鼠,牛,虎,龙 <em>+ 5</em></p>
                            <p class="pr">(組合數：<em>1</em>,總金額：<em>5</em>)</p>
                            <p><span>賠　率</span> 34.500/34.500/34.500/34.500</p>
                        </div>
                        <div class="bd">
                            <table class="g-t1 g-t2 tr">
                                <thead><tr><th colspan="5">組合清單</th></tr></thead>
                                <tbody nomovod>
                                <tr><td  width="20%"><em>四肖连(中) 鼠,牛,虎,龙</em>(34.500)</td><td width='20%'>&nbsp;</td><td width='20%'>&nbsp;</td><td width='20%'>&nbsp;</td><td width='20%'>&nbsp;</td></tr></tbody></table>
                        </div>
                        <div class="ft"></div>
                    </div>
                </div>
